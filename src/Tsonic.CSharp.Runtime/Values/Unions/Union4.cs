...
public readonly struct Union<T1, T2, T3, T4> : IEquatable<Union<T1, T2, T3, T4>>
{
    ...
    private Union(byte index, T1 value1, T2 value2, T3 value3, T4 value4)
    {
        _index = index;
        _value1 = value1;
        _value2 = value2;
    ...
    public static Union<T1, T2, T3, T4> From2(T2 value) => new(2, default!, value, default!, default!);
    ...
    public static Union<T1, T2, T3, T4> From3(T3 value) => new(3, default!, default!, value, default!);
    ...
    public static Union<T1, T2, T3, T4> From4(T4 value) => new(4, default!, default!, default!, value);
    ...
    public TResult Match<TResult>(Func<T1, TResult> onT1, Func<T2, TResult> onT2, Func<T3, TResult> onT3, Func<T4, TResult> onT4) => _index switch
    {
        1 => onT1(_value1),
        2 => onT2(_value2),
        3 => onT3(_value3),
    ...
    public bool Equals(Union<T1, T2, T3, T4> other) => _index == other._index && (_index switch
    {
    ...
    public override bool Equals(object? value) => value is Union<T1, T2, T3, T4> other && Equals(other);
    ...
    public static bool operator ==(Union<T1, T2, T3, T4>? left, T1 right) => left.HasValue && left.Value.Is1() && EqualityComparer<T1>.Default.Equals(left.Value._value1, right);
    ...
    public static bool operator !=(T1 left, Union<T1, T2, T3, T4>? right) => !(right == left);
    public static bool operator ==(Union<T1, T2, T3, T4>? left, T2 right) => left.HasValue && left.Value.Is2() && EqualityComparer<T2>.Default.Equals(left.Value._value2, right);
    ...
    public static bool operator !=(T2 left, Union<T1, T2, T3, T4>? right) => !(right == left);
    public static bool operator ==(Union<T1, T2, T3, T4>? left, T3 right) => left.HasValue && left.Value.Is3() && EqualityComparer<T3>.Default.Equals(left.Value._value3, right);
    ...
    public static bool operator !=(T3 left, Union<T1, T2, T3, T4>? right) => !(right == left);
    public static bool operator ==(Union<T1, T2, T3, T4>? left, T4 right) => left.HasValue && left.Value.Is4() && EqualityComparer<T4>.Default.Equals(left.Value._value4, right);
